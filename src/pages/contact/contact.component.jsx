      ...
      <ContactContainer>
        ...
        <Container>
          <h4 className="text-center">
            Frontend developer and Javascript engineer. View my Projects, Articles, Resumé, Contact Me, or send me
            an email at jefferie.halo@gmail.com.
          </h4>
          <hr />
          <div className="col-md-7 m-auto">
            <div className="card">
              <p>
                Email: <b>jefferie.halo@gmail.com</b>
              </p>
              {/* <p>
                Website:{' '}
                <b>
              ...
              <p>
                Twitter:{' '}
                <b>
                  <a href="https://twitter.com/jeffDZ40">Twitter Profile</a>
                </b>
              </p>
              <p>
                LinkedIn:{' '}
                <b>
                  <a href="https://www.linkedin.com/in/jefferson-ighalo-581aa379/">
                    LinkedIn Profile
                  </a>
                </b>
              </p>
